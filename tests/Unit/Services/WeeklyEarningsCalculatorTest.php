...
final class WeeklyEarningsCalculatorTest extends TestCase
{
    ...
    public function calculate_returns_empty_arrays_for_empty_collection(): void
    {
        ...
        $this->assertInstanceOf(WeeklyMetrics::class, $result);
        $this->assertEmpty($result->weeklyEarnings);
        $this->assertSame(0, $result->totalAmount);
        $this->assertSame(0.0, $result->totalHours);
    }
    ...
    #[Test]
    public function calculate_returns_correct_structure(): void
    {
        $entry = $this->createMock(TimeEntry::class);
        ...
        $this->assertIsFloat($result->totalHours);
    }
