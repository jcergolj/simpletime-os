...
final class TimeEntryTest extends TestCase
{
    ...
    public function get_effective_hourly_rate_returns_time_entry_rate_when_set(): void
    {
        ...
        $project->hourlyRate = $projectRate;
        $project->save();
        $client->hourlyRate = $clientRate;
        $client->save();
        $user->hourlyRate = Money::fromDecimal(25.00, Currency::USD);
        $user->save();
        ...
        $timeEntry->hourlyRate = $timeEntryRate;
        $timeEntry->save();
    ...
    {
        $user = User::factory()->create();
        $user->hourlyRate = Money::fromDecimal(50.00, Currency::USD);
        $user->save();
