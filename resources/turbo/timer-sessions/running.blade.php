<div class="relative px-4 py-2 lg:px-6 lg:py-3 min-h-[216px] lg:min-h-[276px] flex flex-col"
    ...
    <div>
        ...
        <div class="flex justify-between items-start -mt-2 -mx-4 lg:-mt-3 lg:-mx-6 mb-1.5 lg:mb-2">
            <a href="{{ route('running-timer-session.edit') }}"
               data-turbo-frame="timer-widget"
               class="inline-flex items-center px-3 py-1.5 rounded-lg border border-transparent hover:border-base-300 transition-colors font-medium text-base-content/70 hover:text-base-content text-sm"
               title="{{ __('Edit Timer') }}">
                {{ __('Edit') }}
            </a>
