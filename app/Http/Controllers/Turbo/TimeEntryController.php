        ...
        if ($request->boolean('is_recent', false)) {
            ...
            return response()
                ->view('dashboard', [
                    ...
                    'preselectedClientId' => $lastEntry?->client_id,
                    'preselectedClientName' => $lastEntry?->client?->name,
                    'preselectedProjectId' => $lastEntry?->project_id,
                    'preselectedProjectName' => $lastEntry?->project?->name,
                ])
                ->header('X-Turbo-Action', 'morph');
        }
